...
const Card: FC = () => {
    return (
        <div className="bg-white shadow-lg rounded-sm transition duration-100 hover:shadow-sm">
            <div className="h-65 w-auto rounded-t-sm relative">
                <Image
                    src={"/hero.jpg"}
                    width={384}
                    height={256}
            ...
            <div className="p-8">
                ...
                <div className="flex items-center justify-between">
                    ...
                    <Link
                        href={"#"}
                        className="px-6 py-2.5 md:px-10 md:py-3 font-semibold text-white bg-orange-400 rounded-sm hover:bg-orange-500 traansition duration-150"
                    >
                        Book Now
                    </Link>
                </div>
