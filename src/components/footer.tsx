...
const Footer: React.FC = () => {
    return (
        <footer className="bg-gray-900">
            <div className="max-w-secreen-xl mx-auto px-4 w-full py-10 md:py-16">
                <div className="grid md:grid-cols-3 gap-7">
                    <div>
                        ...
                        <p className="text-gray-400">
                            ...
                            porro, itaque nam eligendi illum.
                        </p>
                    </div>
                    <div>
                        <div className="flex gap-20">
                            ...
                            <div className="flex-1 md:flex-none">
                                ...
                                <ul className="list-item space-y-5 text-gray-400">
                                    ...
                                    <li>
                                        <Link href={"#"}>Payment Methhod</Link>
                                    </li>
                                    <li>
            ...
            <div className="max-w-secreen-xl mx-auto px-4 border-t border-gray-500 py-8 text-center text-base text-gray-500">
                &copy; {new Date().getFullYear()} || REMIRA STUDIO. All rights reserved.
            </div>
        </footer>
    );
};
